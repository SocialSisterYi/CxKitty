...
从[Action](https://github.com/SocialSisterYi/CxKitty/actions/workflows/package-exe.yml)中获取最新的自动构建文件,解压后执行文件即可(请先配置配置文件)
...
右侧点击**绿色**的**最上面**的名为`Package Executable`
